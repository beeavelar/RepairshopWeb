...
namespace RepairshopWeb.Migrations
{
    ...
    [Migration("20221030153747_ChangeAppointmentAndRepairOrder")]
    partial class ChangeAppointmentAndRepairOrder
    {
            ...
            modelBuilder.Entity("RepairshopWeb.Data.Entities.Billing", b =>
                {
                    ...
                    b.HasOne("RepairshopWeb.Data.Entities.RepairOrder", "RepairOrder")
                        .WithOne("Billing")
                        .HasForeignKey("RepairshopWeb.Data.Entities.Billing", "RepairOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
